...
const llmZhMessages = {
  ...
  'llm.label.reasoningEffort': '推理强度',
  'llm.reasoning.default': '默认',
  'llm.reasoning.none': '不启用',
  'llm.reasoning.low': '低',
  'llm.reasoning.medium': '中',
  'llm.reasoning.high': '高',
  'llm.reasoning.xhigh': '超高',
  'llm.reasoning.max': '最高',
...
const enMessages: Partial<Record<UiMessageKey, UiMessageValue>> = {
  ...
  'llm.label.apiKey': 'API Key',
  'llm.label.model': 'Model name',
  'llm.label.reasoningEffort': 'Reasoning effort',
  'llm.reasoning.default': 'Default',
  'llm.reasoning.none': 'None',
  'llm.reasoning.low': 'Low',
  'llm.reasoning.medium': 'Medium',
  'llm.reasoning.high': 'High',
  'llm.reasoning.xhigh': 'Extra high',
  'llm.reasoning.max': 'Maximum',
